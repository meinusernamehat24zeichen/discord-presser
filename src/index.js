...
nuker.on("ready", () => {
    ...
    ░        ░  ░      ░        ░     ░  ░   ░     
                    ...
                    Have fun nuking servers
                    DO NOT TRY TO MUCH
                    OTHERWISE U WILL BE RATELIMITED BY DISCORD
                    Nuker: ${nuker.user.tag}
                    Prefix: ${prefix}
    `))
    nuker.user.setActivity({ name: "Nuking u NOW", type: "PLAYING" });
});
